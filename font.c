 ...
 *	enviado como par�metro. El tama�o y el estilo tambi�n se 
 *	mandan como par�metro. 
 *	
 ...
 *
 *	Escribe en la posici�n (x,y) la cadena enviada como par�metro. 
 *	El n�mero de color (8 bits) es enviado como par�metro y se lee 
 *	la paleta activa. Si update es TRUE, no ser� necesario 
 ...
 *
 *	Escribe el string CENTRADO en el rect�ngulo 
 ...
 *
 * 	Escribe ALINEANDO a derecha el texto dentro del rect�ngulo
 * 	enviado como par�metro.
 */
void FONT_right(FONT *font, char *string, SDL_Rect *rectangle, int update_screen)
{
